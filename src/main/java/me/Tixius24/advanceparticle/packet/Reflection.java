...
public class Reflection {
	...
	private static String getIRegistryParam(int version) {
		...
		case 20:
			...
			return "k";
		case 21:
			if (plugin.getServerVersion().equals("v1_21_R6") || plugin.getServerVersion().equals("v1_21_R7")) {
				return "j";
			}
			return "i";
		default:
