...
public class Reflection {
	...
	public static void sendPacket(Player p, Object packet) {
		try {
			...
			Field field = nms_player.getClass().getField(plugin.getServerVersion().equalsIgnoreCase("v1_21_R2") || (plugin.getServerVersion().equalsIgnoreCase("v1_21_R3") || plugin.getServerVersion().equalsIgnoreCase("v1_21_R4")) ? "f" : plugin.getVersionNumber() > 19 ? "c" : (plugin.getVersionNumber() > 16 ? "b" : "playerConnection"));
