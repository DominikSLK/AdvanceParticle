	...
	public static Object createPacket(String particle, double x, double y, double z) {
		try {
			...
			if (plugin.getVersionNumber() > 16) {
				if (plugin.getServerVersion().equalsIgnoreCase("v1_21_R3") || plugin.getServerVersion().equalsIgnoreCase("v1_21_R4") || plugin.getServerVersion().equalsIgnoreCase("v1_21_R5")) {
